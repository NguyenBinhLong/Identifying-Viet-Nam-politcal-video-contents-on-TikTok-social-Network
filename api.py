...
def add_message():
    ...
    _video_id = content['review']
    ####### INIT
    # video_id = "7113876486179851546"
    video_id = _video_id.strip()
    ...
    #
    # result = u'{ text_prediction_score : ' + text_prediction_score + ', image_prediction_score: ' + image_prediction_score + ', face_regconition: ' + face_regconition + ', fusion_score: ' + fusion_score + '}'
